...
"""
    ...
    file_name    = f"../runtime_logs/cot_sc{SAMPLE_NUMS}_ua2webshopRunTimeEnv_L{L}_USER{USER_NUM}_TASK{TASK_NUM}_{datetime.now().strftime('%Y-%m-%d-%H-%M')}.txt"               # log file for results
    avg_reward   = []
    success_rate = []
    avg_time     = []
    avg_money    = []
