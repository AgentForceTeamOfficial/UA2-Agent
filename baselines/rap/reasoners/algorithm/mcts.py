...
class MCTS(SearchAlgorithm, Generic[State, Action, Example]):
    ...
    def search(self, **kwargs):
        ...
        self.root = MCTSNode(state=self.world_model.init_state(current_page = kwargs['current_page']), action=None, parent=None, calc_q=self.calc_q)
    ...
    def __call__(self,
        ...
        self.search(current_page = kwargs['current_page'])
