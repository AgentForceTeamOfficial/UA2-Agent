...
score_prompt = '''Given an item to purchase and a trajectory that aims to buy an item that exactly matches the specification, which corresponds to the ideal score of 1.0, analyze the following trajectory, then at the last line conclude "Thus the correctness score is s", where s is an integer from 1 to 10. Please format your answer in a json file with the following format: {{"score": s, "feedback": "your feedback here"}}. 
...
Now it's your turn, make sure that your answer is formatted in a json format: {{"score": s, "feedback": "your feedback here"}}.
'''
